...
class snapfer_countries extends o3_cms_objects {
	...
	*/		
	public function get_by_ip( $ip ) { 
		...
		$sql = "SELECT 
					t1.*
				FROM 
					".$this->o3->mysqli->escape_string($this->o3->mysqli->tablename('snapfer_ips'))." AS t2
				LEFT JOIN
