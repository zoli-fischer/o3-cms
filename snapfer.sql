...
--
-- AUTO_INCREMENT for table `o3_cms_menu_groups`
--
ALTER TABLE `o3_cms_menu_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `o3_cms_menu_items`
--
ALTER TABLE `o3_cms_menu_items`
...
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_countries`
--
ALTER TABLE `o3_cms_snapfer_countries`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_email_queue`
--
ALTER TABLE `o3_cms_snapfer_email_queue`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_payments`
--
ALTER TABLE `o3_cms_snapfer_payments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_transfers`
--
ALTER TABLE `o3_cms_snapfer_transfers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_transfer_files`
--
ALTER TABLE `o3_cms_snapfer_transfer_files`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_transfer_recipients`
--
ALTER TABLE `o3_cms_snapfer_transfer_recipients`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `o3_cms_snapfer_users`
--
ALTER TABLE `o3_cms_snapfer_users`
...
--
-- AUTO_INCREMENT for table `o3_cms_users`
--
ALTER TABLE `o3_cms_users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
