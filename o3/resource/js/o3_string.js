...
function o3_nl2br(str, is_xhtml ) {
	...
	// *     example 3: nl2br("\nOne\nTwo\n\nThree\n", true);
	// *     returns 3: '<br />\nOne<br />\nTwo<br />\n<br />\nThree<br />\n'
	str = typeof str != 'undefined' && str ? str.toString() : '';
...
* @param boolean allowed Optional second parameter to specify tags which should not be stripped. 
* @retur string
*/
function o3_strip_tags(input, allowed) {
